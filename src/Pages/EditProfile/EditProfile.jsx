...
export default function EditProfile() {
   ...
   async function updatePhoto(value){
        let imgData = value.photo[0];
      ...
      if(data.message == "success"){
        getUserData()
        toast.success("Change Photo Successfully")
      }
  ...
  return (
   <>
   <form onSubmit={handleSubmit(updatePhoto)} className='w-3/4 mx-auto'>
...
<button type="submit" className="my-2.5 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Change Profile Photo</button>
